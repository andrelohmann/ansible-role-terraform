...
![Last test](https://github.com/andrelohmann/ansible-role-terraform/actions/workflows/test.yml/badge.svg)

## Content

Use this role to provision terraform
...
The default variable will istall the latest terraform version, but you can set explicit version numbers

    terraform_version: 1.6.16 # defaults to 'latest'
